<x-app-layout>
    <section class="book_view_admin flex flex-col gap-8 lg:flex-row mt-8 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
        ...
        <div class="info mt-8">
            ...
            <div class="info__buttons mt-4 flex space-x-4">
                ...
                @else
                <p>Debes <a href="{{route('login')}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">iniciar sesion</a> para poder descargar libros</p>
                @endauth
